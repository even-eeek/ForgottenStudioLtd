...
contract PetManager is IERC721Receiver, Pausable, Ownable{
    ...
    function checkAmount(uint256 value, uint256 ticketCount) internal returns (bool) {
        ...
        uint256 lowerPriceLimit = (ticketCount * nftPrice * 1000000000000000000) / ownerPrice;
